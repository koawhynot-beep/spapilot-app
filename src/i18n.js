...
const EN = {
  ...
  'history.pane.stock': 'Stock health',
  ...
  // Stock health
  'stockHealth.lowStock': 'Running low',
  'stockHealth.deadCount': 'Not moving',
  'stockHealth.deadValue': 'Value sitting still',
  'stockHealth.exportStock': 'Export stock to CSV',
  'stockHealth.runningOut': 'Running out',
  'stockHealth.runningOutHint': 'at or below the level you set',
  'stockHealth.leftOf': 'left of',
  'stockHealth.fastMoving': 'Selling fastest',
  'stockHealth.perMonth': 'pieces sold per month on the rail',
  'stockHealth.perMonthShort': 'per month',
  'stockHealth.notMoving': 'Not selling',
  'stockHealth.days': 'days',
  'stockHealth.neverSold': 'never sold',
  'stockHealth.sinceSold': 'since last sold',
  'stockHealth.tiedUp': 'tied up',
  'stockHealth.allMoving': 'Everything is moving',
...
const ID = {
  ...
  'history.pane.stock': 'Kondisi stok',
  ...
  'stockHealth.lowStock': 'Hampir habis',
  'stockHealth.deadCount': 'Tidak bergerak',
  'stockHealth.deadValue': 'Nilai yang mengendap',
  'stockHealth.exportStock': 'Unduh stok (CSV)',
  'stockHealth.runningOut': 'Hampir habis',
  'stockHealth.runningOutHint': 'pada atau di bawah batas yang Anda tetapkan',
  'stockHealth.leftOf': 'sisa dari',
  'stockHealth.fastMoving': 'Paling cepat terjual',
  'stockHealth.perMonth': 'potong terjual per bulan',
  'stockHealth.perMonthShort': 'per bulan',
  'stockHealth.notMoving': 'Tidak terjual',
  'stockHealth.days': 'hari',
  'stockHealth.neverSold': 'belum pernah terjual',
  'stockHealth.sinceSold': 'sejak terakhir terjual',
  'stockHealth.tiedUp': 'nilai mengendap',
  'stockHealth.allMoving': 'Semua bergerak',
